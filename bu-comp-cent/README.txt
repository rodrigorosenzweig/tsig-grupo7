...
a persistence unit "bu-comp-centPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "bu-comp-cent\pom.xml":
...
artifacts ("bu-comp-cent-ejb.jar" and "bu-comp-cent-web.war") are already built. You can build
